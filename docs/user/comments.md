...
![image](../assets/img/comment-parts.png)
...
```
The API documentation for [Document.add_comment][docx.document.Document.add_comment] provides further details.

## Accessing and using the Comments collection

The comments collection is accessed via the [Document.comments][docx.document.Document.comments] property:
